...
{
    public class SelfDeliveryOrderInfoPanelViewModel : OrderInfoPanelViewModelBase
    {
        public SelfDeliveryOrderInfoPanelViewModel(
            ICommonServices commonServices,
            IOrderRepository orderRepository,
            IOrderParametersProvider orderParametersProvider,
            SelfDeliveryOrder order) : base(commonServices, orderRepository, orderParametersProvider)
        {
            Order = order;
