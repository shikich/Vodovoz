...
{
    public class ClosingDocOrderInfoPanelViewModel : OrderInfoPanelViewModelBase
    {
        public ClosingDocOrderInfoPanelViewModel(
            ICommonServices commonServices,
            IOrderRepository orderRepository,
            IOrderParametersProvider orderParametersProvider,
            ClosingDocOrder order) : base(commonServices, orderRepository, orderParametersProvider)
        {
            Order = order;
