...
namespace Vodovoz.Dialogs.Email
{
	public class SendDocumentByEmailViewModel : UoWWidgetViewModelBase
	{
		...
		public SendDocumentByEmailViewModel(IEmailRepository emailRepository, 
			IEmployeeRepository employeeRepository, IInteractiveService interactiveService, IUnitOfWork uow = null)
		{
