...
namespace Vodovoz.ViewModels.Dialogs.Fuel
{
	public class FuelTransferDocumentViewModel : EntityTabViewModelBase<FuelTransferDocument>
	{
		...
		private JournalViewModelBase driverJournalViewModel;
		public JournalViewModelBase DriverJournalViewModel {
			get {
				if(driverJournalViewModel == null) {
					driverJournalViewModel = employeeJournalFactory.CreateWorkingEmployeeJournal();
				}

				return driverJournalViewModel;
			}
		}

		private JournalViewModelBase carJournalViewModel;
		public JournalViewModelBase CarJournalViewModel {
			get {
				if(carJournalViewModel == null) {
					carJournalViewModel = carJournalFactory.CreateDefaultCarsJournal();
				}
				return carJournalViewModel;
			}
		}
