	...
	partial class MainClass
	{
		...
		static void ConfigureViewModelWidgetResolver()
		{
            ...
            ViewModelWidgetResolver.Instance
				...
				.RegisterWidgetForWidgetViewModel<DeliveryOrderInfoViewModel, DeliveryOrderInfoView>()
				.RegisterWidgetForWidgetViewModel<VisitingMasterOrderInfoViewModel, VisitingMasterOrderInfoView>()
				.RegisterWidgetForWidgetViewModel<ClosingDocOrderInfoViewModel, ClosingDocOrderInfoView>()
				.RegisterWidgetForWidgetViewModel<OrderFrom1cInfoViewModel, OrderFrom1cInfoView>()
				...
				.RegisterWidgetForWidgetViewModel<DeliveryOrderMainViewModel, OrderMainView>()
				.RegisterWidgetForWidgetViewModel<VisitingMasterOrderMainViewModel, OrderMainView>()
				.RegisterWidgetForWidgetViewModel<ClosingDocOrderMainViewModel, OrderMainView>()
				.RegisterWidgetForWidgetViewModel<OrderFrom1cMainViewModel, OrderMainView>()
				.RegisterWidgetForWidgetViewModel<SelfDeliveryOrderInfoPanelViewModel, SelfDeliveryOrderInfoPanelView>()
				.RegisterWidgetForWidgetViewModel<DeliveryOrderInfoPanelViewModel, DeliveryOrderInfoPanelView>()
				.RegisterWidgetForWidgetViewModel<VisitingMasterOrderInfoPanelViewModel, VisitingMasterOrderInfoPanelView>()
				.RegisterWidgetForWidgetViewModel<ClosingDocOrderInfoPanelViewModel, ClosingDocOrderInfoPanelView>()
				.RegisterWidgetForWidgetViewModel<OrderFrom1cInfoPanelViewModel, OrderFrom1cInfoPanelView>()
